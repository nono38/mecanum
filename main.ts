radio.onReceivedNumber(function (receivedNumber) {
    if (receivedNumber == 2) {
        ...
        wuKong.mecanumSpeed(wuKong.WheelList.RightFront_def, 200)
        wuKong.mecanumSpeed(wuKong.WheelList.RightRear_def, 200)
    } else if (receivedNumber == 6) {
        wuKong.mecanumSpeed(wuKong.WheelList.LeftFront_def, 200)
        wuKong.mecanumSpeed(wuKong.WheelList.LeftRear_def, 200)
    }
})
music.setVolume(109)
wuKong.mecanumWheel(
